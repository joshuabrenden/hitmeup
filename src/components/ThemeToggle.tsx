...
export function ThemeToggle() {
  ...
  if (!mounted) {
    ...
    return (
      <button className="w-10 h-10 rounded-lg bg-gray-200 animate-pulse" aria-label="Loading theme toggle" />
    )
  }
  ...
  return (
    <button
      onClick={cycleTheme}
      className={`
        relative w-10 h-10 rounded-lg transition-colors duration-200
        ${actualTheme === 'dark' 
